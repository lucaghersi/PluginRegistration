...
namespace Ofscrm.PluginRegistration.Wrappers
{
    ...
    public sealed class CrmOrganization
    {
        #region Private Fields
        ...
        public CrmOrganization(ConnectionDetail detail, OrganizationConnectionOptions connectionOptions)
        {
            if (detail == null)
            {
            ...
            OrganizationHelper.OpenConnection(this, OrganizationHelper.RetrieveMessages(this), connectionOptions);
        }
