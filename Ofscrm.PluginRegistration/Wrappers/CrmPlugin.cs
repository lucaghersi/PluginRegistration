...
namespace Ofscrm.PluginRegistration.Wrappers
{
    ...
    [Serializable]
    public sealed class CrmPlugin : ICrmEntity, ICloneable
    {
        ...
        public string EntityType
        {
            get
            {
                return Ofscrm.PluginRegistration.Entities.PluginType.EntityLogicalName;
            }
        }
        ...
        public Dictionary<string, object> GenerateCrmEntities()
        {
            ...
            entityList.Add(Ofscrm.PluginRegistration.Entities.PluginType.EntityLogicalName, plugin);
